...
const CustomerReviewList = () => {
  ...
  const {
    ...
    setSelectedRowKeys
  } = useReviewList('customer_resource');
      ...
      >
        {currentReview && (
          <div>
            ...
            <p><strong>客资信息：</strong>
              {currentReview.userNoteInfo?.customerPhone && (
                <span>📞{currentReview.userNoteInfo.customerPhone} </span>
              )}
              {currentReview.userNoteInfo?.customerWechat && (
                <span>💬{currentReview.userNoteInfo.customerWechat}</span>
              )}
              {!currentReview.userNoteInfo?.customerPhone && !currentReview.userNoteInfo?.customerWechat && '未填写'}
            </p>
