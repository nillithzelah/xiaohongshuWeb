...
- ✅ 应该判断为符合的情况：
  ...
  - **维权教程、退费教程、维权话术** → ✅ 可以接受（如"医美退费话术"、"减肥维权方法"、"赌石维权教程"）
  - **维权流程建议、科普知识** → ✅ 可以接受（如医美退费流程、维权注意事项、避雷指南）
  ...
  - **教程/指南类内容** → ✅ 可以接受
    - 只要内容与13类维权相关，教程、指南、话术分享都可以接受
    - 例如："医美退费话术教程"、"维权流程指南"、"避雷指南"等都应接受
    - 关键是内容是否与13类的维权/退费/被骗相关
...
- ❌ 必须拒绝的情况（重要！）：
  ...
  - 招聘诈骗：兼职被骗、招聘被骗、入职被骗
  - 教育诈骗：课程被骗、培训被骗、学费被骗（不含医美/减肥等13类培训）
  - 装修诈骗：装修被骗、建材被骗
...
- **不需要是个人真实经历**，维权知识科普、流程建议、服务提供、教程分享都可以
- **维权教程和话术是允许的**，如"医美退费话术"、"维权流程教程"等
...
async function main() {
  ...
  console.log('');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('📝 更新 note_audit 提示词（明确教程类内容可接受）');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // 显示关键变更
  console.log('📋 主要变更:');
  console.log('  ✅ 明确：教程/指南/话术类内容可以接受');
  console.log('  ✅ 明确：医美退费话术、维权流程教程等都应接受');
  console.log('  ✅ 强调：只要是13类相关的内容，教程也可以通过');
  console.log('');
